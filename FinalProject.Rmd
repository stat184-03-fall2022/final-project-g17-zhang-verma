...
- During 2020 and 2021, how has the mileage on Dodge Challengers changed due to Covid?
...
- Comparing the years on each Dodge Challenger, what is the prediction on the prices in 2040?
...
### Research Questions
In this project, we are interested in exploring the averages and different trends amongst all the country. There are several research questions we are interested in: 
-  What are the top 10 most populated countries.
-  What is the trend of death and birth in the top 10 most populated country?
-  Are the top 10 most populated country the same as the top 10 country which have the largest area?
-  Which country has the highest obesity, unemployment, and education?
