...
(A) .Rmd Line numbers where at least two different data sources are imported: 25, 115


(B) .Rmd Line numbers for inspecting data intake:  27, 117


### Data Wrangling / Cleaning / etc (4 out of 7 required)


(A) .Rmd Line number(s) for general data wrangling: 56, 57


(B) .Rmd Line number(s) for a join operation: 225


(C) .Rmd Line number(s) for a pivot_wider or pivot_longer operation (or equivalent):   NA


(D) .Rmd Line number(s) for use of regular expressions: 196-200


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 213-215


(F) .Rmd Line number(s) for use of user-defined functions: NA
...
(A) .Rmd Line numbers for use of multiple different geoms:  146-174

(B) .Rmd Line number(s) for use of multiple aesthetics: 71-72

(C) .Rmd Line number(s) for use of layered graphics:  NA

(D) .Rmd Line number(s) for use of leaflet or choropleth maps:  NA
